...
namespace DS
{
    ...
    public class DialogueManagerMama : MonoBehaviour
    {
        public GameObject dialogueBoxOscar;
        public GameObject Oscar;
        public GameObject colliderHermano;
        ...
        public void NextMessage()
        {
            ...
            if (currentDialogue == null)
            {
                ...
                Outline outline = reloj.AddComponent<Outline>();
                outline.enabled = true;

                text.GetComponent<Text>().text = "Toma el reloj de la mesa";
            }
        ...
        public void escogerDecision(int decision)
        {
            ...
            if (currentDialogue.DialogueName == "Mama4")
            {
                respiracion.Stop();
                enojo.Play();
            }
            else if (currentDialogue.DialogueName == "Mama5")
            {
                enojo.Stop();
                llanto.Play();
            }
            else if (currentDialogue.DialogueName == "Mama7")
            {
                llanto.Stop();
                enojo.Play();
            }
