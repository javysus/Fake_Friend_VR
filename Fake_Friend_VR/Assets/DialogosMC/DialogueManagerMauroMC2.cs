...
namespace DS
{
    ...
    public class DialogueManagerMauroMC2 : MonoBehaviour
    {
        ...
        public void DisplayMessage()
        {
            ...
            if (currentDialogue.Choices[0].Text == "Next Dialogue")
            {
                ...
                if (currentDialogue.DialogueName == "Mau7")
                {
        ...
        public void NextMessage()
        {
            ...
            if (currentDialogue == null)
            {
                ...
                isActive = false;
                //activar la linea de coca
                //entregar papel

            }
            else if (currentDialogue.DialogueName == "Mau8")
            {
                isActive = true;
            }
            else
        ...
        public void escogerDecision(int decision)
        {
            ...
            if (currentDialogue.DialogueName == "Mau8")
            {
                isActive = false;
            }
            else
