...
namespace DS
{
    ...
    public class DialogueManagerRestobar : MonoBehaviour
    {
        ...
        public IEnumerator tiempoParaLeer()
        {
            Debug.Log("Tiempo para leer");
        ...
        public void DisplayMessage()
        {
            ...
            if (currentDialogue.Choices[0].Text == "Next Dialogue")
            {
                ...
                /*else if (currentDialogue.DialogueName == "Mesera2")
                {
                    StartCoroutine(tiempoParaLeer());
                    Debug.Log("Han pasado 5 seg");
                }*/
        ...
        public void NextMessage()
        {
            ...
            if (currentDialogue == null)
            {
                ...
                Cami.transform.position = new Vector3(-0.349999994f, 2.89899993f, 4.36000013f);
                CamiAnimator.SetTrigger("idle");
                dialogueBoxConi.transform.localRotation = Quaternion.Euler(0, 0, 0);
                this.enabled = false;
        ...
        void FixedUpdate()
        {
            if (moverMesera)
            {
                if (Mesera.transform.position == irDerecho)
                {
                    ...
                    Mesera.transform.localRotation = Quaternion.Euler(0, 90, 0);
