...
namespace DS
{
    ...
    public class DialogueManagerJosefA : MonoBehaviour
    {
        ...
        public GameObject collisionBesar;
        ...
        void DisplayMessage()
        {
            ...
            if (currentDialogue.Choices[0].Text == "Next Dialogue")
            {
                ...
                if (currentDialogue.DialogueName == "Josefa9")
                {
                    Debug.Log("Esperar beso");

                    collisionBesar.SetActive(true);
                    isActive = false;
