...
namespace DS
{
    ...
    public class DialogueManagerRave2 : MonoBehaviour
    {
        ...
        public void OpenDialogue(DSDialogueSO dialogue)
        {
            ...
            isActive = true;
            Luis.GetComponent<LogicaLuisNPC>().dialogo1 = false;
            DisplayMessage();
        ...
        public void NextMessage()
        {
            ...
            if (currentDialogue == null)
            {
                ...
                pasosBaile.SetActive(true);
                rightController.GetComponent<objetivosDer>().enabled = true;
                leftController.GetComponent<objetivosIzq>().enabled = true;

                FeniaController = Fenia.GetComponent<Animator>();
                FeniaController.SetTrigger("bailar1_trigger");

                LuisController = Luis.GetComponent<Animator>();
                LuisController.SetTrigger("bailar1_trigger");
