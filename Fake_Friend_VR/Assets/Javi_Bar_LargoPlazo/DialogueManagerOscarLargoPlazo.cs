...
namespace DS
{
    ...
    public class DialogueManagerOscarLargoPlazo : MonoBehaviour
    {
        ...
        public void OpenDialogue(DSDialogueSO dialogue)
        {
            ...
            Oscar.GetComponent<OscarLargoPlazo>().pedirAyudaDecision = false;
            isActive = true;
        ...
        public void NextMessage()
        {
            ...
            if (currentDialogue == null)
            {
                ...
                isActive = false;
                Oscar.transform.LookAt(new Vector3(Target.position.x, Oscar.transform.position.y, Target.position.z));
                OscarController = Oscar.GetComponent<Animator>();
                OscarController.SetTrigger("abrazar");
